"""This is the game functions module to check events"""
import sys
import pygame
...
def check_keydown_events(event, ai_settings, screen, ship, bullets):
	...
	if event.key == pygame.K_RIGHT:
		...
		#Create a bullet and addt it to the group
...
def check_bullet_alien_collisions(ai_settings, screen, ship, aliens, bullets):
	...
	if len(aliens) == 0:
		#Destroy existing bullets and creae a new fleet
		bullets.empty()
		create_fleet(ai_settings, screen, ship, aliens)
...
def create_fleet(ai_settings, screen, ship, aliens):
	...
	#Create an alien and find the number in a row
	# Spacing between each alien is equal to one aliend widght
	alien = Alien(ai_settings, screen)
